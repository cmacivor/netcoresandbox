...
namespace ServiceReference1
{
    ...
    public partial class UserInformation : object
    {
        ...
        private System.Collections.Generic.List<string> WindowsLogonField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public System.Collections.Generic.List<string> WindowsLogon
        {
            get
            {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1-preview-30310-0943")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://ci.richmond.va.us/services", ConfigurationName="ServiceReference1.INoneyaWebService")]
    public interface INoneyaWebService
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ci.richmond.va.us/services/INoneyaWebService/GetRichvaUsersInAppRole", ReplyAction="http://ci.richmond.va.us/services/INoneyaWebService/GetRichvaUsersInAppRoleRespon" +
            "se")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetRichvaUsersInAppRoleAsync(string appId, string role);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ci.richmond.va.us/services/INoneyaWebService/GetRichvaUsersInAppRoleDepart" +
            ...
            "mentResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetRichvaUsersInAppRoleDepartmentAsync(string appId, string role, string department);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetUsersInRoleAsync(string appId, string role);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetApplicationRolesAsync(string appId);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetUserRolesAsync(string appId, string userLogonName);
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetDepartmentsAsync();
        ...
        System.Threading.Tasks.Task<System.Collections.Generic.List<ServiceReference1.DepartmentInfo>> GetDepartmentsInfoAsync();
        ...
        System.Threading.Tasks.Task<ServiceReference1.UserInformation> GetUserInformationAsync(string userName);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ci.richmond.va.us/services/INoneyaWebService/GetUserInformationFromId", ReplyAction="http://ci.richmond.va.us/services/INoneyaWebService/GetUserInformationFromIdRespo" +
            "nse")]
        System.Threading.Tasks.Task<ServiceReference1.UserInformation> GetUserInformationFromIdAsync(int noneyaId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://ci.richmond.va.us/services/INoneyaWebService/GetUsersDepartmentName", ReplyAction="http://ci.richmond.va.us/services/INoneyaWebService/GetUsersDepartmentNameRespons" +
            "e")]
        System.Threading.Tasks.Task<ServiceReference1.UserDepartmentName> GetUsersDepartmentNameAsync(string userName);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1-preview-30310-0943")]
    public interface INoneyaWebServiceChannel : ServiceReference1.INoneyaWebService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1-preview-30310-0943")]
    public partial class NoneyaWebServiceClient : System.ServiceModel.ClientBase<ServiceReference1.INoneyaWebService>, ServiceReference1.INoneyaWebService
    {
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetRichvaUsersInAppRoleAsync(string appId, string role)
        {
            return base.Channel.GetRichvaUsersInAppRoleAsync(appId, role);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetRichvaUsersInAppRoleDepartmentAsync(string appId, string role, string department)
        {
            return base.Channel.GetRichvaUsersInAppRoleDepartmentAsync(appId, role, department);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetUsersInRoleAsync(string appId, string role)
        {
        ...
        public System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetApplicationRolesAsync(string appId)
        {
            return base.Channel.GetApplicationRolesAsync(appId);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetUserRolesAsync(string appId, string userLogonName)
        {
            return base.Channel.GetUserRolesAsync(appId, userLogonName);
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetDepartmentsAsync()
        {
            return base.Channel.GetDepartmentsAsync();
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<ServiceReference1.DepartmentInfo>> GetDepartmentsInfoAsync()
        {
            return base.Channel.GetDepartmentsInfoAsync();
        }
        
        public System.Threading.Tasks.Task<ServiceReference1.UserInformation> GetUserInformationAsync(string userName)
        {
            return base.Channel.GetUserInformationAsync(userName);
        }
        
        public System.Threading.Tasks.Task<ServiceReference1.UserInformation> GetUserInformationFromIdAsync(int noneyaId)
        {
            return base.Channel.GetUserInformationFromIdAsync(noneyaId);
        }
        
        public System.Threading.Tasks.Task<ServiceReference1.UserDepartmentName> GetUsersDepartmentNameAsync(string userName)
        {
